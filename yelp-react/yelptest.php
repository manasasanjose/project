...
extract($_POST);
//var_dump($_POST);
$API_KEY='Dahsf_yxY8YH4-SccZO-Kd_iFjtzLTt_ZY-W7fA6CNb73CnLqU2ygK4-5PTWUM3WQm3_Na5bZvXou_-T4bhCKBcjMQMN6i10NL6Q7JFFZRma3lwvR9W0ohkYvNMYW3Yx';
...
function query_api($term, $location) {     
   ...
   //print sprintf("Details  for business \"%s\" found:\n", $name);
    //$pretty_response = json_encode(json_decode($response), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES);
	//$pretty_response = json_encode(json_decode($response));
	$pretty_response = json_encode($response->businesses);
...
$location = $_POST['locations'] ?: $GLOBALS['DEFAULT_LOCATION'];
